  ...
  return (
    <div className="w-full flex justify-around sm:justify-between align-middle sm:px-[3.75rem] mt-10">
      ...
      <FormControl>
        ...
        >
          <MenuItem value={"Africa"} onClick={()=>handleChoice("africa")}>Africa</MenuItem>
          <MenuItem value={"America"} onClick={()=>handleChoice("america")}>America</MenuItem>
          <MenuItem value={"Asia"} onClick={()=>handleChoice("asia")}>Asia</MenuItem>
          <MenuItem value={"Oceania"} onClick={()=>handleChoice("oceania")}>Oceania</MenuItem>
          <MenuItem value={"Europe"} onClick={()=>handleChoice("europe")}>Europe</MenuItem>
        </Select>
      </FormControl>
    </div>
  );
